...
function Quiz() {
  ...
  if (loading) return (
    ...
    >
      <p className="text-white text-center mt-10 bg-[#1C2541] bg-opacity-80 p-6 rounded-xl">
        Loading quiz... 🌀
      </p>
    </div>
  );
  ...
  return (
    <div 
      ...
      style={getBackgroundStyle()}
    >
      <div className="bg-[#1C2541] bg-opacity-90 p-8 rounded-2xl shadow-2xl w-full max-w-xl space-y-6 border border-[#324766] transition-transform duration-300 hover:scale-[1.01]">
        {/* Progress Bar */}
